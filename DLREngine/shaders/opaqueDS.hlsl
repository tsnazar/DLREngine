...
float4 ps_main(VS_OUTPUT input) : SV_Target
{
    ...
    float3 resultColor = calculatePointLighting(N, GN, V, L, view, input.radius, input.radiance, material, visibilityCalculation(GN, normalize(L), posWS, g_shadowMap, input.instanceID));
